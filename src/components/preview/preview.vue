...
export default class Preview extends Vue {
  ...
  private _initialRegisterEvent () {
    ...
    eventHandle.addEvent(Preview.container ? Preview.container : document, 'mousewheel', throttle(this.mouseHandle, 100));
    eventHandle.addEvent(Preview.container ? Preview.container : document, 'DOMMouseScroll', throttle(this.mouseHandle, 100));
    eventHandle.addEvent(Preview.container ? Preview.container : document, 'mouseenter', this.handleShowActionWrapper);
    eventHandle.addEvent(Preview.container ? Preview.container : document, 'mouseleave', this.handleHiddenActionWrapper);
